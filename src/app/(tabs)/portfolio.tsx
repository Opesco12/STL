...
const Portfolio = () => {
  ...
  const [totlaPortfolioBalance, setTotalPortfolioBalance] = useState(0);
      ...
      {loading ? (
        ...
        <View style={styles.container}>
          ...
          >
            ...
            >
              {totlaPortfolioBalance &&
                amountFormatter.format(totlaPortfolioBalance)}
            </StyledText>
          </ContentBox>
