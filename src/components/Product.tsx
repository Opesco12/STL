...
import ProductDefault from "../../assets/images/svg_images/ProductDefault";
import MoneyMarketFund from "../../assets/images/svg_images/MoneyMarketFund";
...
const Product = React.forwardRef(({ onPress, product }, ref) => {
  ...
  const products = ["STL MONEY MARKET FUND", "STL BALANCED FUND"];

  const CustomImage = products?.includes(product.portfolioName)
    ? product.portfolioName === "STL MONEY MARKET FUND"
      ? MoneyMarketFund
      : ProductDefault
    : ProductDefault;

  const imageUrl =
    CustomImage === MoneyMarketFund
      ? require("../../assets/images/money_market_fund.png")
      : require("../../assets/images/product_default.png");
